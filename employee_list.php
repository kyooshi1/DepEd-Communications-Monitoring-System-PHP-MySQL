					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      ...
		                      <a class="dropdown-item assign_role" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Grant a Role</a>
...
<script>
	...
	$('.assign_role').click(function(){
		uni_modal("<i class='fa fa-id-card'></i> Grant a role","assign_role.php?id="+$(this).attr('data-id'))
	})
